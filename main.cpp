...
int main(int argc, const char** argv){
    ...
    if (onGPU)
        strOut << std::fixed << std::setprecision(2) << "images/out_gpu_" << WIN_WIDTH << "x" << WIN_HEIGHT << ".bmp";
    else
        strOut << std::fixed << std::setprecision(2) << "images/out_cpu_" << WIN_WIDTH << "x" << WIN_HEIGHT << ".bmp";
