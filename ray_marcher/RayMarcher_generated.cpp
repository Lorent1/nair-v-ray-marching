...
void RayMarcher_Generated::UpdateVectorMembers(std::shared_ptr<vk_utils::ICopyEngine> a_pCopyEngine)
{
}

void RayMarcher_Generated::UpdateTextureMembers(std::shared_ptr<vk_utils::ICopyEngine> a_pCopyEngine)
{ 
}
...
void RayMarcher_Generated::copyKernelFloatCmd(uint32_t length)
{
...
VkBufferMemoryBarrier RayMarcher_Generated::BarrierForClearFlags(VkBuffer a_buffer)
{
...
VkBufferMemoryBarrier RayMarcher_Generated::BarrierForSingleBuffer(VkBuffer a_buffer)
{
  VkBufferMemoryBarrier bar = {};
  bar.sType               = VK_STRUCTURE_TYPE_BUFFER_MEMORY_BARRIER;
  bar.pNext               = NULL;
...
void RayMarcher_Generated::BarriersForSeveralBuffers(VkBuffer* a_inBuffers, VkBufferMemoryBarrier* a_outBarriers, uint32_t a_buffersNum)
{
...
void RayMarcher_Generated::GetExecutionTime(const char* a_funcName, float a_out[4])
{
